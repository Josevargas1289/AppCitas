...
useEffect(() => {
  ...
  // editar los pacientes
    ...
    if (paciente.id) {
      objetoPacient.id = paciente.id
      const pacienteActualizado = pacientes.map(pacienteState => pacienteState.id === paciente.id ? objetoPacient : pacienteState)
      setPacientes(pacienteActualizado)
      setPaciente({})
      
    } else {
      objetoPacient.id = generarId()
  ...
  return (
    <div className="md:w-2/3 lg:w-2/5 m-5 mr-20">
      <h2 className="font-black text-3xl text-center mt-4 mr-4">
